...
outputfile = str(input("Output file name .txt: "))
...
if 'yes':
	out = open(outputfile, 'wb')
 	subprocess.Popen(awstagch, stdout=output, stderr=subprocess.STDOUT,shell=True, executable='/bin/bash')	
	subprocess.call('enscript -p out.ps file,shell=True,executable='/bin/bash')
